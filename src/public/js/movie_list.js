...
//collect genre name  y url parameter from local storage
...
fetchDataFromServer(
  `https://api.themoviedb.org/3/discover/movie?api_key=${api_key}&page=${currentPage}&sort_by=popularity.desc&${urlParam}`,
