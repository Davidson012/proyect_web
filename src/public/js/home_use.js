...
/**
 * Home page section (top rated, Upcoming Trendig movies)
 */
...
const heroBanner = function ({ results: movieList }) {
    ...
    <div class="banner-content">
      ...
      <a href="#" id="loginLink" class="btn" onclick= "getMovieDetail(${id})">
        <img
          ...
          alt="play_circle"
        />
        <span class="span">Add Watchlist</span>
      </a>
    </div>
  `;
    ...
    controlItem.setAttribute("slider-control", `${controlItemIbdex}`);
  ...
  /**
   * fetch data form homepages section (Top Rated , Upcoming, trending)
   */
